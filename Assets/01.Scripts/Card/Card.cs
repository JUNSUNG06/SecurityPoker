...
public class Card : MonoBehaviour
{
    ...
    {
        if(isPlayerCard && gameController.stateMachine.nowState.GetType() == gameController.stateMachine.stateList[typeof(StateSetting)].GetType() && GameController.Instance.canDrag)
        {
            if(amount > 0)
            {
